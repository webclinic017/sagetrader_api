...
DATABASE_URL_HEROKU = None #os.environ['DATABASE_URL'] # Heroku

DATABASE_URL_DEFAULT = (
    f"postgresql://{POSTGRES_USER}:{POSTGRES_PASSWORD}@{POSTGRES_SERVER}/{POSTGRES_DB}"
)
if DATABASE_URL_HEROKU:
    SQLALCHEMY_DATABASE_URI = DATABASE_URL_HEROKU
else:
    SQLALCHEMY_DATABASE_URI = DATABASE_URL_DEFAULT
